...
def createScene(rootNode):
    ...
    MeasuredPosition.addObject('MechanicalObject', name='MeasuredPositionM0', position=[0,0,0,0,0,0,1], template = "Rigid3d", showObject = True,showObjectScale = 5)
    MeasuredPosition.addObject('PositionEffector', template="Rigid3d", indices='0', effectorGoal="@../../goal/goalM0.position",useDirections=[0, 0, 0, 1, 1, 1],weight = 100) # classic
